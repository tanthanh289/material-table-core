              ...
              {(provided, snapshot) => {
                ...
                return (
                  <div
                    ...
                    style={props.options.doubleHorizontalScroll ? { display: "inline-block", minWidth: "100%" } : undefined}
                  >
                    <div
                      ref={this.tableContainerDiv}
                      style={{
                        display: props.options.doubleHorizontalScroll ? "inline-block" : "block",
                        minWidth: props.options.doubleHorizontalScroll ? "100%" : undefined,
                    ...
                    >
                      ...
                      <div style={props.options.doubleHorizontalScroll ? { display: "inline-block", minWidth: "100%" } : undefined}>
                        {table}
                      </div>
